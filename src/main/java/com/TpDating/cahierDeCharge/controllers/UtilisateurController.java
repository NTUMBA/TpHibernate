...
public class UtilisateurController {
	...
	public ModelAndView enregistrement() {
		...
		return new ModelAndView("/fragments/form").addObject("user", new Utilisateur())
													...
													.addObject("ci", new CentreInteret())
													.addObject("sexe", Sexe.values())
													.addObject("colorEyes", ColorEyes.values())
													.addObject("alcool", Alcool.values())
													.addObject("fumeur", Fumeur.values())
													.addObject("origine", Origine.values())
													.addObject("statusPerso", StatusPerso.values())
		                                            .addObject("statusPro", StatusPro.values())
													.addObject("orientation", Orientation.values())
								      				.addObject("typeStreet", MultimediaType.values())
								      				.addObject("colorHair", ColorHair.values())
								      				.addObject("prefix", AdressePrefixe.values())
								      				.addObject("typeStreet", AdressTypeStreet.values())
								      				.addObject("typeHair", TypeHair.values());
